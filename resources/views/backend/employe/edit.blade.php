...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Employe | Edit') }}</div>
                <div class="card-body">
                    <form id="contactForm" action="{{ route('backend.edit.process.employe') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div><small class="text-seccondary"><i>Kosongkan inputan jika tak ingin mengubah gambar</i></small></div>
                                    <img src="{{ asset('image/employes/'. $item->image) }}" class="img-thumbnail mt-3 mb-3 w-50" id="old_preview">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="select2 form-control" name="department_id" class="">
                                        ...
                                        @foreach ($departments as $department)
                                            <option value="{{ $department->id }}" @if ( $department->name == $item->department->name)
                                                selected
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="fullname" value="{{ $item->fullname }}" placeholder="fullname" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="slug" value="{{ $item->slug }}" placeholder="slug" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="hp" value="{{ $item->hp }}" placeholder="hp" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea 
                                        ...
                                        name="cv" placeholder="cv">{!! $item->cv !!}
                                    </textarea>
                                    @error('cv')
                                        <small class="text-danger">{!! $message !!}</small>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea 
                                        ...
                                        name="address" placeholder="address">{!! $item->address !!}
                                    </textarea>
                                    @error('address')
                                        <small class="text-danger">{!! $message !!}</small>
                                    @enderror
