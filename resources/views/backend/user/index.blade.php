                          ...
                          <tr>
                            ...
                            <td>
                                @if (Auth::User()->name != $item->name)
                                    ...
                                    <a href="{{ route('backend.show.user', $item->id) }}" class="btn btn-sm btn-primary">
                                ...
                                @endif
                                @if (Auth::User()->name == $item->name)
                                    <a href="{{ route('backend.edit.user.me') }}" class="btn btn-sm btn-success">
                                        <i class="fa-solid fa-pencil"></i> Edit
                                    </a>

                                    <a href="{{ route('backend.show.user.me') }}" class="btn btn-sm btn-primary">
                                        <i class="fa-solid fa-search"></i> Show
                                    </a>
                                @endif
                            </td>
