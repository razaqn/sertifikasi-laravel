    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="contactForm" action="{{ route('backend.edit.process.product') }}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="id_category">
                                        ...
                                        <option value="1" @if ($item->id_category == '1') selected @endif>Baru</option>
                                        <option value="2" @if ($item->id_category == '2') selected @endif>Bekas</option>
                                    </select>
                                    @error('id_category')
                                        <small class="text-danger">{!! $message !!}</small>
                                    @enderror
